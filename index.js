...
console.log(color('> WA NUMBER: +923180608149 ','silver'))
...
dogexeon.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
   ...
   // owner
    ...
    const htod = "923180608149@s.whatsapp.net"
...
dogexeon.on('group-update', async (anu) => {
    ...
    dogexeon.on('chat-update', async (message) => {
        ...
        ownerNumber = ["923180608149@s.whatsapp.net","923180608149@s.whatsapp.net",`${settings.NomorOwner}@s.whatsapp.net`]
        dtod = "923180608149@s.whatsapp.net"
